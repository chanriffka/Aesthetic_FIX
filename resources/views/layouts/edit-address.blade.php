...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-2xl">
        ...
        <div class="text-center mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Edit Address</h2>
        </div>

        <!-- Form -->
        <form action="{{ route('order.address.update', ['id'=> $address->ADDRESS_ID]) }}" method="POST" class="space-y-6">
            @csrf
            <!-- Name Field -->
            <div>
                <label for="FULLNAME" class="block text-gray-700 font-medium mb-1">Full Name</label>
                <input id="FULLNAME" name="FULLNAME" type="text" placeholder="Enter your name" value="{{ $address->FULLNAME }}"
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <input id="PHONE" name="PHONE" type="tel" placeholder="8123456789" value="{{ $address->PHONE }}"
            ...
            <div>
                ...
                <textarea id="ADDRESS" name="ADDRESS" rows="3" placeholder="Street, House Number, etc."
                    class="w-full border rounded-lg px-4 py-3 focus:ring-indigo-500 focus:border-indigo-500 outline-none">{{ $address->ADDRESS }}</textarea>
            </div>
            ...
            <div class="flex space-x-4">
                <div class="w-1/2">
                    ...
                    <input id="PROVINCE" name="PROVINCE" type="text" placeholder="Province" value="{{ $address->PROVINCE }}"
                ...
                <div class="w-1/2">
                    ...
                    <input id="CITY" name="CITY" type="text" placeholder="City" value="{{ $address->CITY }}"
                        class="w-full border rounded-lg px-4 py-3 focus:ring-indigo-500 focus:border-indigo-500 outline-none">
                </div>
            </div>
            ...
            <div>
                ...
                <input id="POSTAL_CODE" name="POSTAL_CODE" type="text" placeholder="Postal Code" value="{{ $address->POSTAL_CODE }}"
                    class="w-full border rounded-lg px-4 py-3 focus:ring-indigo-500 focus:border-indigo-500 outline-none">
            </div>
